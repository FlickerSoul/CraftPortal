...
// MARK: - Class Path Test Data

extension ClassPathTests {
...
// MARK: - Argument Test Data

extension ArugmentsTests {
...
// MARK: - Expected Launch Result Wrapper
...
// MARK: - Launch Script Generation Test
...
// MARK: - General Launch Script Test Data
...
// MARK: - Vanilla Game Launch Script Test Data
...
extension LaunchScriptTests {
    ...
    static let expectedVanillaGameShellScript = {
        ...
        return try! String(contentsOfFile: shellPath.string, encoding: .utf8)
            .trimmingCharacters(in: .whitespacesAndNewlines)
    }()
